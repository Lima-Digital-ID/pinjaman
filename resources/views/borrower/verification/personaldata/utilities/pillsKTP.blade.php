<div class="tab-pane fade show active" id="pills-ktp" role="tabpanel" aria-labelledby="pills-ktp-tab">
    <div class="form-group row">
        <label for="" class="col-md-2">Form KTP</label>
        <input type="file" class="form-control col-md-4">
    </div>
    <div class="form-group row">
        <label for="" class="col-md-2">Form Memegang KTP</label>
        <input type="file" class="form-control col-md-4">
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <input type="number" class="form-control col-md-4" max="12">
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="" class="col-md-2">Pilih Kantor Cabang</label>
        <select name="" id="" class="form-control col-md-4">

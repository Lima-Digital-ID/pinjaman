<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
      <a class="nav-link active" id="pills-ktp-tab" data-toggle="pill" href="#pills-ktp" role="tab" aria-controls="pills-ktp" aria-selected="true">KTP</a>
    </li>
    <li class="nav-item" role="presentation">
    ...
    <li class="nav-item" role="presentation">
      <a class="nav-link" id="pills-work-tab" data-toggle="pill" href="#pills-work" role="tab" aria-controls="pills-contact" aria-selected="false">Pekerjaan</a>
    </li>
    <li class="nav-item" role="presentation">

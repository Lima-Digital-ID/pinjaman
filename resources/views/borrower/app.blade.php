...
<head>
  ...
  <link href="{{ asset('assets/sb-admin-2.css') }}" rel="stylesheet">
  
  <link href="{{ asset('assets/vendor/select2-develop/dist/css/select2.min.css') }}" rel="stylesheet" />
  <link href="{{ asset('assets/vendor/bootstrap-datepicker/dist/css/bootstrap-datepicker3.standalone.min.css') }}" rel="stylesheet" />
